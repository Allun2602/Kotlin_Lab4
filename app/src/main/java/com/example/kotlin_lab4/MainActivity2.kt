    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_send.setOnClickListener {
            if(ed_drink.length()<1)
                ...
                b.putString("suger",radioGroup.findViewById<RadioButton>(radioGroup.checkedRadioButtonId)
                    .text.toString())
                b.putString("ice",radioGroup2.findViewById<RadioButton>(radioGroup2.checkedRadioButtonId)
                    .text.toString())
